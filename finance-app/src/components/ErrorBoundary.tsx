...
// update depth exceeded", помилка Supabase-запиту без власного catch тощо),
// без цього весь застосунок лишається білим/непрацездатним екраном без
// жодного способу вийти, крім закриття вкладки. Ловить помилку, показує
// дружній екран з кнопкою "Перезавантажити" замість краху всього SPA.
//
...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  componentDidCatch(error: Error, info: ErrorInfo): void {
    console.error('ErrorBoundary спіймав помилку рендеру:', error, info.componentStack)
  }
