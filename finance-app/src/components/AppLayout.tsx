      ...
      >
        <main className="flex-1 overflow-y-auto">
          {/* key={pathname} — скидає межу помилки при переході на ІНШИЙ
              маршрут: краш конкретного екрана (напр. Огляд інвестицій) не
              ламає застосунок назавжди — BottomNav/SecondaryNav лишаються
              видимі поза цією межею, тож можна просто тапнути іншу вкладку
              і застосунок відновиться сам, без кнопки "Перезавантажити". */}
